    ...
    var MediaGallery = function( obj ) {
        ...
        var _addGalleryContent = function( msg ){
            ...
            _addEvents = function () {
                ...
                _window.on( {
                    resize: function() {
                        ...
                        } else if ( _window.width() >= 748 && !_swiper ) {
            ...
            _initGallery = function() {
                ...
                var items = _wrapper.find( '.media-gallery__item' );

                _wrapper = _obj.find( '.media-gallery__wrap' );
                _galleryItemClass = '.media-gallery__item';

                if ( _window.width() < 1200 && _window.width() >= 768  && items.length <= 2 ){
                ...
                } else if ( _window.width() >= 1200  && items.length <= 4 ){
            ...
            _checkCenterBlocks = function () {

                if ( _window.width() < 1200 && _window.width() >= 768 ){

                    var items = _wrapper.find( '.media-gallery__item' );

                    if ( items.length == 1 ) {

                        items.css( 'left', ( _wrapper.width() - items.width() - 14 ) / 2 )

                    } else if ( items.length == 2 ) {

                        items.eq( 0 ).css( 'left', ( _wrapper.width() - items.width() * 2 ) / 2 );
                        items.eq( 1 ).css( 'left', ( _wrapper.width() - 6 ) / 2 );

                    }

                    _centeredBlocks = true;
                    ...
                    if ( items.length == 1 ) {
                        ...
                        items.eq( 0 ).css( 'left', ( _wrapper.width() - items.width() * 3 ) / 2 );
                        items.eq( 1 ).css( 'left', ( _wrapper.width() - items.width() - 6 ) / 2 );
                        items.eq( 2 ).css( 'left', ( _wrapper.width() + items.width() - 6 ) / 2 );

                    } else if ( items.length == 4 ) {

                        items.eq( 0 ).css( 'left', ( _wrapper.width() - items.width() * 4 ) / 2 );
                        items.eq( 1 ).css( 'left', ( _wrapper.width() - items.width() * 2 ) / 2 );
                        items.eq( 2 ).css( 'left', ( _wrapper.width() - 6 ) / 2 );
                        items.eq( 3 ).css( 'left', ( _wrapper.width() + items.width() * 2 - 6 ) / 2 );
